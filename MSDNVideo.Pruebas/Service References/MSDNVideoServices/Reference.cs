...
namespace MSDNVideo.Pruebas.MSDNVideoServices {
    ...
    public interface IMSDNVideoServices {
        ...
        MSDNVideo.Comun.Pelicula[] Peliculas_ObtenerPeliculas(bool incluirActores);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IMSDNVideoServices/Peliculas_ObtenerPeliculasPorFiltro", ReplyAction="http://tempuri.org/IMSDNVideoServices/Peliculas_ObtenerPeliculasPorFiltroResponse" +
            "")]
        MSDNVideo.Comun.Pelicula[] Peliculas_ObtenerPeliculasPorFiltro(out int total, MSDNVideo.Comun.FiltroPeliculas filtro, bool incluirActores, bool incluirPuntuaciones);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IMSDNVideoServices/Peliculas_ObtenerTopPeliculasAlquiler", ReplyAction="http://tempuri.org/IMSDNVideoServices/Peliculas_ObtenerTopPeliculasAlquilerRespon" +
            "se")]
        MSDNVideo.Comun.Pelicula[] Peliculas_ObtenerTopPeliculasAlquiler();
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IMSDNVideoServices/Peliculas_ObtenerTopPeliculasVentas", ReplyAction="http://tempuri.org/IMSDNVideoServices/Peliculas_ObtenerTopPeliculasVentasResponse" +
            "")]
        MSDNVideo.Comun.Pelicula[] Peliculas_ObtenerTopPeliculasVentas();
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IMSDNVideoServices/Peliculas_ObtenerTopPeliculasPuntuacion", ReplyAction="http://tempuri.org/IMSDNVideoServices/Peliculas_ObtenerTopPeliculasPuntuacionResp" +
            "onse")]
        MSDNVideo.Comun.Pelicula[] Peliculas_ObtenerTopPeliculasPuntuacion();
        ...
        MSDNVideo.Comun.Usuario[] Usuarios_ObtenerUsuarios();
        ...
        MSDNVideo.Comun.Socio[] Usuarios_ObtenerSocios();
        ...
        MSDNVideo.Comun.Socio[] Usuarios_ObtenerSociosPorNombre(string nombre);
        ...
        MSDNVideo.Comun.Actor[] Actores_ObtenerActores();
        ...
        MSDNVideo.Comun.Actor[] Actores_ObtenerActoresPorNombre(string nombre);
        ...
        MSDNVideo.Comun.Alquiler[] ObtenerAlquileresSinRecoger(bool incluirSocio, bool incluirPelicula);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IMSDNVideoServices/Notificaciones_ObtenerNotificaciones", ReplyAction="http://tempuri.org/IMSDNVideoServices/Notificaciones_ObtenerNotificacionesRespons" +
            "e")]
        MSDNVideo.Comun.Notificacion[] Notificaciones_ObtenerNotificaciones(bool incluirSocio, bool incluirPelicula);
        ...
        MSDNVideo.Comun.InformeSaldos[] Informes_ObtenerInformeSaldos(out MSDNVideo.Comun.SaludInforme saludInforme);
        ...
        MSDNVideo.Comun.InformeVentas[] Informes_ObtenerInformeVentas(out MSDNVideo.Comun.SaludInforme saludInforme);
        ...
        MSDNVideo.Comun.InformeStock[] Informes_ObtenerInformeStock(out MSDNVideo.Comun.SaludInforme saludInforme);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IMSDNVideoServicesChannel : MSDNVideo.Pruebas.MSDNVideoServices.IMSDNVideoServices, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class MSDNVideoServicesClient : System.ServiceModel.ClientBase<MSDNVideo.Pruebas.MSDNVideoServices.IMSDNVideoServices>, MSDNVideo.Pruebas.MSDNVideoServices.IMSDNVideoServices {
        ...
        public MSDNVideo.Comun.Pelicula[] Peliculas_ObtenerPeliculas(bool incluirActores) {
            return base.Channel.Peliculas_ObtenerPeliculas(incluirActores);
        }
        
        public MSDNVideo.Comun.Pelicula[] Peliculas_ObtenerPeliculasPorFiltro(out int total, MSDNVideo.Comun.FiltroPeliculas filtro, bool incluirActores, bool incluirPuntuaciones) {
        ...
        public MSDNVideo.Comun.Pelicula[] Peliculas_ObtenerPeliculasPendienteDevolver(string nifUsuario) {
        ...
        public MSDNVideo.Comun.Pelicula[] Peliculas_ObtenerTopPeliculasVentas() {
            return base.Channel.Peliculas_ObtenerTopPeliculasVentas();
        }
        
        public MSDNVideo.Comun.Pelicula[] Peliculas_ObtenerTopPeliculasPuntuacion() {
        ...
        public MSDNVideo.Comun.Usuario[] Usuarios_ObtenerUsuarios() {
            return base.Channel.Usuarios_ObtenerUsuarios();
        }
        
        public MSDNVideo.Comun.Socio[] Usuarios_ObtenerSocios() {
            return base.Channel.Usuarios_ObtenerSocios();
        }
        
        public MSDNVideo.Comun.Socio[] Usuarios_ObtenerSociosPorNombre(string nombre) {
        ...
        public MSDNVideo.Comun.Actor[] Actores_ObtenerActores() {
            return base.Channel.Actores_ObtenerActores();
        }
        
        public MSDNVideo.Comun.Actor[] Actores_ObtenerActoresPorNombre(string nombre) {
        ...
        public MSDNVideo.Comun.Alquiler[] ObtenerAlquileresSinRecoger(bool incluirSocio, bool incluirPelicula) {
            return base.Channel.ObtenerAlquileresSinRecoger(incluirSocio, incluirPelicula);
        }
        
        public MSDNVideo.Comun.Notificacion[] Notificaciones_ObtenerNotificaciones(bool incluirSocio, bool incluirPelicula) {
            return base.Channel.Notificaciones_ObtenerNotificaciones(incluirSocio, incluirPelicula);
        }
        
        public MSDNVideo.Comun.InformeSaldos[] Informes_ObtenerInformeSaldos(out MSDNVideo.Comun.SaludInforme saludInforme) {
            return base.Channel.Informes_ObtenerInformeSaldos(out saludInforme);
        }
        
        public MSDNVideo.Comun.InformeVentas[] Informes_ObtenerInformeVentas(out MSDNVideo.Comun.SaludInforme saludInforme) {
            return base.Channel.Informes_ObtenerInformeVentas(out saludInforme);
        }
        
        public MSDNVideo.Comun.InformeStock[] Informes_ObtenerInformeStock(out MSDNVideo.Comun.SaludInforme saludInforme) {
